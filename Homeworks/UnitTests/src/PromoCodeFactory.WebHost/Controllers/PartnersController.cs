...
namespace PromoCodeFactory.WebHost.Controllers
{
        ...
        : ControllerBase
    {
        ...
        public async Task<ActionResult<PartnerPromoCodeLimit>> GetPartnerLimitAsync(Guid id, Guid limitId)
        {
            ...
            //а если партнер не активен, разве мы должны выводить хоть какую-то инфу по нему?
        ...
        public async Task<IActionResult> CancelPartnerPromoCodeLimitAsync(Guid id)
        {
            ...
            //Отключение лимита
            //TODO: Поправил логику - мы должны отменять только те, которые еще активные, т.е. EndDate > DateTime.Now
